...
@section('content')
	...
	<div class="container container-web-page">
	    ...
	    <p class="text-justify">¡Bienvenido a Maxi Pizza! Aquí encontrarás los mejores platos que harán que tu paladar se deleite. Desde nuestras irresistibles pizzas hasta las pastas más sabrosas, cada bocado es una explosión de sabor. Prepárate para disfrutar de una experiencia culinaria única. ¡Buen provecho!
